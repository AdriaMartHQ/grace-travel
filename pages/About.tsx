...
const aboutContent: Record<'zh' | 'en' | 'tr', AboutContent> = {
  zh: {
    ...
    title: '我们是谁',
    subtitle:
      '土耳其本地 A 组持牌旅行社，扎根伊斯坦布尔。土耳其精品游、信仰朝圣、巴尔干三国、以色列圣地——全程中文，费用透明。',
    intro: [
      '来土耳其（或巴尔干、以色列），需要的不只是一张行程表，而是一个真正能托付的人。',
      '恩途 Grace Way Travel Agency 是一家总部位于伊斯坦布尔的本地持牌旅行社，TÜRSAB A 组认证，证书编号 18717，依法运营，公开可查。我们专注于服务中国及全球华人旅客——从土耳其人文经典游、信仰朝圣之旅，到巴尔干三国深度团与以色列圣地灵修。',
    ...
    services: [
      ...
      '巴尔干三国深度游（塞尔维亚 · 黑山 · 波黑 · 12天）',
      '以色列圣地朝圣（耶路撒冷 · 加利利 · 死海 · 8天）',
      '机场接送 & 土耳其全境包车',
    ...
    profileBody: [
      ...
      '服务网络覆盖土耳其全境（伊斯坦布尔、卡帕多奇亚、棉花堡、以弗所、安塔利亚、费特希耶、特罗亚等），并延伸至巴尔干三国（塞尔维亚、黑山、波黑）及以色列。',
    ...
    recognitionLead:
      '恩途深耕土耳其、巴尔干与圣地旅游，以下是核心目的地覆盖范围',
    recognitionPoints: [
      '土耳其全境：伊斯坦布尔 · 卡帕多奇亚 · 棉花堡 · 以弗所 · 安塔利亚 · 费特希耶 · 特罗亚 · 伊兹密尔',
      '信仰之旅：启示录七教会（以弗所·士每拿·别迦摩等）· 保罗足迹 · 卡帕多奇亚洞穴教堂',
      '巴尔干三国：贝尔格莱德（塞尔维亚）· 科托尔湾 · 布德瓦（黑山）· 萨拉热窝 · 莫斯塔尔（波黑）',
      '以色列圣地：耶路撒冷 · 加利利 · 约旦河 · 伯利恒 · 死海 · 纳撒勒 · 海法',
      '商务 & 会展：商务考察 · 展会接待 · MICE 会奖旅游 · VIP 团体接待',
