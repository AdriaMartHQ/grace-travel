  ...
  return (
    <div className="bg-[#fdfcfb] text-slate-900 selection:bg-orange-100 overflow-x-hidden">
        ...
        <div className="relative z-20 max-w-6xl animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <h1 className="mb-6 text-white">
            ...
            <span className="mt-3 md:mt-4 block text-[1.9rem] md:text-[3.1rem] lg:text-[3.75rem] font-black serif leading-[1.08] tracking-tight text-white/96">
              {d.hero.title.split('·').slice(1).join('·').trim()}
            </span>
          </h1>
          <p className="text-white/80 text-base md:text-[1.35rem] font-light mb-10 tracking-[0.12em] md:tracking-[0.22em] uppercase">
            {d.hero.subtitle}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href={BOOKING_URLS.S5} className="w-full sm:w-auto px-8 md:px-10 py-4 bg-[#FF9D00] text-white rounded-full font-black uppercase tracking-[0.16em] md:tracking-widest text-[12px] md:text-sm shadow-2xl">
              {d.meta.cta_consult}
            </a>
      ...
      <section className="py-32 bg-slate-950 text-white relative text-center px-6">
        <div className="relative z-10 max-w-4xl mx-auto space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={BOOKING_URLS.S5} className="w-full sm:w-auto px-12 py-5 bg-[#FF9D00] text-white rounded-full font-black uppercase tracking-widest text-sm shadow-xl">
              {d.meta.cta_consult}
            </a>
      ...
      <div className="md:hidden fixed bottom-6 left-6 right-6 z-[60] animate-in slide-in-from-bottom-12 duration-1000">
        <a href={BOOKING_URLS.S5} className="flex items-center justify-between bg-white/95 backdrop-blur-xl border border-slate-200 text-slate-900 p-2 pl-6 rounded-full shadow-2xl">
